...
require('../inc/essentials.php');
 ...
 if(isset($_POST['add_room']))
 {
    ...
    $q2 = "INSERT INTO `room_facilities`(`room_id`,`facilities_id`) VALUE (?,?)";
    ...
    $q3 = "INSERT INTO `room_features`(`room_id`,`features_id`) VALUE (?,?)";
...
if(isset($_POST["edit_room"]))
{
    ...
    $del_features = deleten("DELETE FROM `room_features` WHERE `room_id`=?",[$frm_data['room_id']],'i');
    $del_facilities = deleten("DELETE FROM `room_facilities` WHERE `room_id`=?",[$frm_data['room_id']],'i');
...
if(isset($_POST['remove_room']))
{
    ...
    $res2 = deleten("DELETE FROM `room_images` WHERE `room_id`=?",[$frm_data['room_id']],'i');
    $res3 = deleten("DELETE FROM `room_features` WHERE `room_id`=?",[$frm_data['room_id']],'i');
    $res4 = deleten("DELETE FROM `room_facilities` WHERE `room_id`=?",[$frm_data['room_id']],'i');
